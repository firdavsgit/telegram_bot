...
class Postgres_monoblok():
    ...
    def table_create(self):
        self.cursor.execute("""
            CREATE TABLE IF NOT EXISTS monobloks (
    ...
    def insert(self, *args):
        ...
        self.cursor.execute(f"""
            INSERT INTO monobloks (product_name, description, product_f_name,product_f_value , product_price, product_image) 
            VALUES
             (%s, %s, %s, %s, %s, %s)      
        """, args)
